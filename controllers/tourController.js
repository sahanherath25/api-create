...
exports.getToursStats = async (req, res) => {
  ...
  try {
    ...
    /*
         TODO  This means that only the documents where the ratingsAverage field is greater than or
         TODO  equal to 4.5 will be passed on to the next stage of the pipeline.
         TODO   $match:{ratingsAverage:{$gte:4.5}}
    */
